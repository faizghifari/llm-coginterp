...
RUN apt-get update && apt-get install -y make curl r-base sudo libfreetype6-dev libuv1-dev g++ gfortran libblas-dev liblapack-dev zlib1g-dev cmake libxml2-dev rustup xz-utils libgmp-dev libmpfr-dev wget
