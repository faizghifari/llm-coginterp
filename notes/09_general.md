...
This document categorizes benchmarks related to general capabilities.

## General Benchmarks

### AI2 Reasoning Challenge (`arc`) [Link](https://github.com/huggingface/evaluation-guidebook/blob/main/contents/automated-benchmarks/some-evaluation-datasets.md)
...
### HellaSwag: Can a Machine Really Finish Your Sentence? (`hellaswag`) [Link](https://ar5iv.labs.arxiv.org/html/1905.07830)
...
### Measuring Massive Multitask Language Understanding (`mmlu`) [Link](https://arxiv.org/abs/2009.03300)
**Subcategory:** knowledge

No description available.

### MMLU-Pro: A More Robust and Challenging Multi-Task Language Understanding Benchmark (`mmlu_pro`)
**Subcategory:** knowledge
...
### Natural Questions (`naturalquestions`) [Link](https://huggingface.co/datasets/google-research-datasets/natural_questions)
**Subcategory:** qa
...
### TriviaQA (`triviaqa`) [Link](https://huggingface.co/datasets/mandarjoshi/trivia_qa)
**Subcategory:** qa
